...
"[project]/app/api/extract-activities/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ACTIVITY_PATTERNS = [
    ...
    },
    {
        ...
        patterns: [
            "today.*promote top-up",
            "today's promote top-up",
            "promote top-up.*today",
            "today.*promote.*topup"
        ]
    },
    {
        ...
        patterns: [
            "today.*promote success",
            "today's promote success",
            "promote success.*today"
        ]
    },
    {
        ...
        patterns: [
            ...
            "today's new interesting",
            "new interesting.*today",
            "interesting client"
        ]
    },
    {
...
function extractSequentialNumbers(text) {
    const result = {};
    const keys = [
        "new_clients",
        "today_trust_love",
    ...
    try {
        ...
        if (image && !text) {
            return Response.json({
                error: "Image processing requires AI. Please paste text data instead, or add a credit card to your Vercel account to enable AI features.",
                requiresAI: true
            }, {
                status: 400
            });
        ...
        return Response.json({
            error: "Failed to extract activities"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__66fb5bac._.js.map